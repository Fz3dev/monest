 ...
 * @param {Function} onDelete - Called when delete is confirmed
 * @param {string} [deleteLabel="Supprimer"] - Aria label for delete button
 */
export default function SwipeToDelete({ onDelete, deleteLabel = 'Supprimer', children }) {
