...
import { CONFIG_MODEL, SPLIT_MODE } from '../../types'
...
interface OnboardingWizardProps {
  onComplete?: (household: Household) => void | Promise<unknown>
}
...
export default function OnboardingWizard({ onComplete }: OnboardingWizardProps) {
  ...
  const update = <K extends keyof OnboardingForm>(field: K, value: OnboardingForm[K]) => setForm((f) => ({ ...f, [field]: value }))
  ...
  const COUPLE_MODELS = [
    { value: CONFIG_MODEL.CommonAndPersonal, label: t('onboarding.models.common_and_personal'), description: t('onboarding.models.common_and_personal_desc') },
    { value: CONFIG_MODEL.FullCommon, label: t('onboarding.models.full_common'), description: t('onboarding.models.full_common_desc') },
    { value: CONFIG_MODEL.FullPersonal, label: t('onboarding.models.full_personal'), description: t('onboarding.models.full_personal_desc') },
  ]
          ...
          {step === 1 && (
            ...
            >
              ...
              <Input
                ...
                onChange={(e: React.ChangeEvent<HTMLInputElement>) => update('personAName', e.target.value)}
          ...
          {step === 3 && (
            ...
            >
              ...
              <div>
                ...
                <div className="space-y-2">
                  {([SPLIT_MODE.FiftyFifty, SPLIT_MODE.Custom, SPLIT_MODE.Prorata]).map((mode) => (
                    <button
                      key={mode}
                      onClick={() => {
              ...
              {form.splitMode === 'custom' && (
                <div>
                  ...
                  <input
                    ...
                    onChange={(e: React.ChangeEvent<HTMLInputElement>) => update('splitRatio', parseInt(e.target.value) / 100)}
